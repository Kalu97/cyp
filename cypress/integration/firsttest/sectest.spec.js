describe('Learn Automation', () =>{
    ...
    it('Test the application form', () => {
        ...
        cy.get('input[class="feedback-input"]').eq(0).type('kalu');
        cy.get('input[class="feedback-input"]').eq(1).type('Mane');
        cy.get('input[class="feedback-input"]').eq(2).type('kalumane99@gmail.com');
